...
import { Filter, ListCheck, ListChecks, Plus, Clock } from "lucide-react";
        ...
        <div className={layoutClasses.container}>
            <div className={layoutClasses.headerWrapper}>
                <div>
                    ...
                    <p className="text-sm text-gray-500 mt-1 ml-7"> {sortedPendingTasks.length} task {' '}{sortedPendingTasks.length !== 1 && 's'}
