...
const Layout = ({onLogout, user}) => {
    ...
    if(error) return (
        <div className="min-h-screen bg-gray-50 flex items-center justify-center">
            <div className = 'bg-red-50 text-red-600 p-4 rounded-x1 border border-red-100 max-w-md'>
                ...
                <button onClick={fetchTasks} className="mt-4 px-4 py-2 bg-red-100 text-red-700 rounded-lg text-sm font-medium hover:bg-red-200 transition-colors ">
                    Try Again
                </button>
            </div>
        </div>
    ...
    return (
        <div className = 'min-h-screen bg-gray-50'>
            ...
            <div className="m1-0 x1:m1-64 lg:ml-64 md:ml-16 pt-16 p-3 sm:p-4 transition-all duration-300">
                                ...
                                <div className="relative pt-1">
                                    <div className ="flex gap-1.5 items-center">
                                        <div className ='flex-1 h-2 sm:h-3 bg-purple-100 rounded-full overflow-hidden'>
                                            <div className = 'flex-1 h-2 sm:h-3 bg-gradient-to-r from-fuchsia-500 to-purple-600 transition-all duration-500'
