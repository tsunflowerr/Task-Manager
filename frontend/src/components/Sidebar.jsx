...
const Sidebar = ({user, tasks}) => {
    ...
    const tottalTasks = tasks?.length || 0;
    const completedTasks = tasks?.filter(t => t.completed).length || 0;
    const productivity = tottalTasks > 0 ? Math.round((completedTasks / tottalTasks) * 100) : 0;
    ...
    return (
        <>
        {/* Sidebar component content goes here */ }
                    ...
                    <div className={TIP_CARD.container}>
                        <div className="flex items-center gap-2">
                            ...
                            <div>
                                ...
                                <a href="https://hexagondigitalservices.com/" target="_blank" className="block mt-2 text-sm text-purple-500 hover:underline"> Visit Hexagon Digital Services     
                                </a>
                            </div>
                        </div>
                    </div>
